# -*- coding: utf-8 -*-
"""
Created on Sun Oct 24 03:37:00 2021

@author: Fik
"""

'''
This code "reads" a linear sparse problem's matrix A and compresses it (by CSR).
...
def main():
    ...
    #'''
    Anz, JA, IA = create_CSR(problemElems['A'])
    print("Anz: ", Anz)
    print("JA: ",JA)
    print("IA: ",IA)
    #'''
